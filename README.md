...
``` r
library("dplyr")     # for programming control
library("corrplot")  # for plotting similarity matrix
...
### Number of rows and columns in simulated rasters (sim data only)
cols = 100
rows = 100
