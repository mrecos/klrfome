...
nocite: | 
  @Muandet, @Song, @2017arXiv170504293L, @Flaxman
---
...
This model is inspired by and borrows from Zoltán Szabó's work on mean embeddings [@Szabo, @Szabo2] and Ji Zhu & Trevor Hastie's Kernel Logistic Regression algorithm [@Zhu]. I extend a hardy **thank you** to Zoltán for his correspondence during the development of this approach. However, all errors, oversights, and omissions are my own. 
...
(High-res versions of research poster are in the [/SAA_2018_poster](https://github.com/mrecos/klrfome/tree/master/SAA_2018_poster) folder)
