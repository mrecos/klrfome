...
*   build_K - Function takes list of traning data, scalar value for `sigma` hyperparameter, and a distance method to compute a mean embedding similarity kernel. This kernel is a pair-wise (N x N) matrix of the mean similarity between the attirbutes describing each site location and background group.
